...
export const Sort = {
  RELEVANCE: ["relevance", null] as const,
  NEWEST: ["time", "desc"] as const,
  OLDEST: ["time", "asc"] as const,
  EXPENSIVE: ["price", "asc"] as const,
  CHEAPEST: ["price", "desc"] as const,
} as const;
...
// ── Region ──
// Each region is [regionId, regionName]
export const Region = {
  ALSACE: ["1", "ALSACE"],
...
// ── Department ──
// Each department is [regionId, regionName, departmentId, departmentName]
...
export function createCity(params: { lat: number; lng: number; radius?: number; city?: string }): City {
  return {
    lat: params.lat,
    lng: params.lng,
    radius: params.radius ?? 10_000,
    city: params.city,
  };
}
...
export type LocationType =
  | { type: "region"; value: RegionValue }
  | { type: "department"; value: DepartmentValue }
